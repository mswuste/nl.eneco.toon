...
class OAuth2Account extends EventEmitter {
	...
	constructor(options = {}) {
		...
		this.expiresIn = typeof options.expiresIn === 'string' ? options.expiresIn : Homey.ManagerSettings.get(`oauth2_${this.id}_expiresIn`);
		...
		this.log(`new OAuth2Account constructed (expiresIn: ${this.expiresIn}, id: ${this.id})`);
